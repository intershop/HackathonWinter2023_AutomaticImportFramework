		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<td class="overview_subtitle" nowrap="nowrap" width="100%">
					<a href="<%=context.getFormattedValue(url(true,(new URLPipelineAction(context.getFormattedValue("ViewProcessStatistics-ProcessStatisticsList",null)))),null)%>" class="overview_subtitle"><% {out.write(localizeISText("processstatistics.smc.extension.overview.title.processstatistics","",null,null,null,null,null,null,null,null,null,null,null));} %></a>
				</td>
			</tr>
			<tr>
				<td colspan="2" class="overview_title_description" valign="top">
					<% {out.write(localizeISText("processstatistics.smc.extension.overview.description.processstatistics","",null,null,null,null,null,null,null,null,null,null,null));} %>
					<br />&nbsp;
				</td>
			</tr>
			<tr>
